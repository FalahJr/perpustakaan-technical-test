...
import {
  borrowingSchema,
  type BorrowingSchema,
} from "@/features/borrowings/schemas/borrowing-schema";
      ...
      <form onSubmit={submit} className="space-y-5">
        ...
        <div>
          ...
          <Controller
            ...
            name="tgl_pinjam"
            render={({ field }: { field: any }) => (
              <Input {...field} id="tgl_pinjam" type="date" />
            )}
          />
          {errors.tgl_pinjam ? (
            <p className="mt-2 text-sm text-rose-300">
        ...
        <div>
          ...
          <Controller
            ...
            render={({ field }: { field: any }) => (
              <Input {...field} id="tgl_hrs_kembali" type="date" />
            )}
          />
        ...
        <div>
          ...
          <Controller
            ...
            name="jaminan"
            render={({ field }: { field: any }) => (
              <Input {...field} id="jaminan" placeholder="Contoh: KTP / SIM" />
            )}
          />
          {errors.jaminan ? (
            <p className="mt-2 text-sm text-rose-300">
